	...
	return (
		<div className="container">
			...
			<div className="text text-container side-padding">
				...
				<p>
				As a sign of gratitude towards our first supporters, you will receive a Web 3.0 Raver NFT, designed by one of our founders. The NFT also represents your ticket to receive your tokens during the token generation event. Read more about the seed sale in the litepaper and chat with us in our Telegram group.
				</p>
			</div>
