			...
			<div className="container">
				...
				<div className="text-container side-padding">
					<p className="text">
						...
						<a className="in-txt-link" href="https://www.lifelive.io" target="_blank"> digital web2 platform </a>
						in Berlin, connecting nightlife connoisseurs, ravers, and lonely hearts to their 
						favorite artists, labels, and venues. One experimental festival quickly led to a series 
						of 6 virtual festivals that year, bringing together thousands of fans with some of the 
						biggest names in the Berlin music ecosystem and showing attendees new ways to interact online.
					</p>
					<br></br>
					<p className="text">
					...
					<br></br>
					<p className="text">
						Now in 2022, we’re taking LifeLive to web3. Our vision is to enable a direct connection between artists and fans, 
						shaking up the current system controlled by middlemen, and promote a new wave of global talent in inclusive nightlife settings. 
				...
				<button className="btn btn-style-blue-light zoom">Read litepaper</button>
