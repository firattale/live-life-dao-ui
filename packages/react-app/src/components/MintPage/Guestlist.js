	...
	return (
		<div className="mint-container">
			<div className="div-ticket blue-bg-border">
				...
				<h1 className="no-margin">Guestlist Tier</h1>
				<h2 className="no-margin blue">Receive 30% more tokens</h2>
				<div className="rounded blue-border">
					<h1 className="no-margin">$ 2K</h1>
					<h4 className="no-margin">payable in DAI stablecoin</h4>
				</div>
			</div>
			<ul>
				<li>Your investment counts 30% in the next funding round;</li>
